<template>
	<view class="tui-upload__container">
		<view class="tui-upload-box">
			<view class="tui-image-item" :style="{width:width+'rpx',height:height+'rpx'}" style="margin-right:20rpx;"
			...
			<view v-if="isShowAdd" class="tui-upload-add" :style="{width:width+'rpx',height:height+'rpx'}"
				...
				<span style="font-size: 23rpx;color: #C2D3EE;">上传专属图片</span>
			</view>
		</view>
	</view>
</template>
