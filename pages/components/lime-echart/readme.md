...
```js
import LEchart from '@/pageCopyA/components/lime-echart/components/l-echart/l-echart.vue';
export default {
	components: {LEchart}
}
```
...
import * as echarts from '@/pageCopyA/components/lime-echart/static/echarts.min'
